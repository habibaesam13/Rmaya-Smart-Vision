   ...
   const oldMembers = @json(old('members', []));
    document.querySelectorAll('.weapon-radio').forEach(radio => {
      ...
      /*  for (let i = 0; i < membersCount; i++) {
          const row = `
        <tr>
          <td><input required class="form-control form-control-sm id-num" type="text"  value="${member.ID || ''}"  name="members[${i}][ID]" placeholder="00000000000000"></td>
          <td><input required class="form-control form-control-sm id-date" type="date" value="${member.Id_expire_date || ''}" name="members[${i}][Id_expire_date]"></td>
          <td><input required class="form-control form-control-sm name-input" type="text"  value="${member.name || ''}" name="members[${i}][name]" placeholder="الاسم"></td>
          <td><input style="direction:ltr" required class="form-control form-control-sm    value="${member.phone1 || ''}"  phone-num" type="number" name="members[${i}][phone1]" placeholder="05xxxxxxxx"></td>
          <td><input required class="form-control form-control-sm birth-date" type="date"  value="${member.dob || ''}" name="members[${i}][dob]"></td>
          <td><input required class="form-control form-control-sm age" type="number"   value="${member.age || ''}" name="members[${i}][age]" readonly placeholder="00"></td>
        ...
        for (let i = 0; i < membersCount; i++) {
  const member = oldMembers[i] || {}; // fallback if no old data
