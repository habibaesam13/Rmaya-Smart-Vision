                ...
                <div class="card-body">
                                        ...
                                        <div class="col-4">
                                            <div class="file-upload-wrapper p-1">
                                                <div class="d-flex">
                                                    ...
                                                    <input title="تاريخ الديتيل" name="details_date"
                                                           value="{{ request('details_date')}}"
                                                           type="date"
                                                           class="form-control form-control">
                                                </div>
                                            </div>
                    ...
                    <div class="card shadow-sm border-0" id="printArea">
                        <div class="card-body">
                            ...
                            {{--                                    </thead>--}}
                            {{--                                    <tbody>--}}
                            {{--  every grade has a unique color--}}
                            {{--                                    @php--}}
                            {{--                                        $current=0;--}}
                            {{--                                        $last=count($res)-1;--}}
                            {{--                                        $prevColor = 'white';--}}
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered ">
                                    ...
                                    <tbody>
                                    {{--                            common grades have a unique color and others have white--}}
                                    @php
                                        $current=0;
                                        $last=count($res)-1;
                                        $prevColor = '';
                                    ...
                                    @forelse($res as $index => $item)
                                        @php  $current = $index ;
                                if(( $index > 0 && $index <= $last  && $item->total === $res[$index - 1]->total) && $index > 0 ){
                                    $currentColor = $prevColor;
                                }elseif(( $index > 0 && $index <= $last  && $item->total === $res[$index - 1]->total) && $index == 0){
                                 $currentColor = 'gray';  $currentColor = 'gray';
                                }else{
                                    $r = rand(0, 255);
                                    $g = rand(0, 255);
                                    $b = rand(0, 255);
                                    ...
                                    $prevColor = $currentColor;
                                        ...
                                        {{--{{dd($sortedRatings[$index])}}--}}
                                        @if(($res[$index]?->total  === $res[$index + 1]?->total  || $res[$index]?->total  === $res[$index -1 ]?->total)  && $index > 0)
                                            <tr style="background-color: {{$currentColor}} !important;">

                                            @elseif(($res[$index]?->total  === $res[$index + 1]?->total  || $res[$index]?->total  === $res[$index -1 ]?->total)  && $index == 0)
                                             <tr style="background-color: {{$currentColor}} !important;">
                                            @else
