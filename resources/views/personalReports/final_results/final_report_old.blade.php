                        ...
                        <div class="row form">
                                ...
                                <div class="file-upload-wrapper p-1">
                                    <select name="weapon_id" required id="weaponSelect"
                                        ...
                                        @foreach($weapons as $weapon)
                                            <option  {{ request('weapon_id') == $weapon->wid ? 'selected' : '' }}  value="{{$weapon->wid}}">{{$weapon->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="file-upload-wrapper p-1">
                                    <select  name="club_id"
                                             class="form-control form-control-sm">
                                        <option  {{ request('club_id') === "" ? 'selected' : '' }} value="">اختر النادي .....</option>
                                        @foreach($clubs as $club)
                                            <option  {{ request('club_id') == $club->cid ? 'selected' : '' }}   value="{{$club->cid}}">{{$club->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="file-upload-wrapper p-1">
                                    <select name="rate_limiting"
                                        ...
                                        <option  {{ request('rate_limiting') == 1 ? 'selected' : '' }}   value="1">من الاول الى الأول</option>
                                        <option  {{ request('rate_limiting') == 2 ? 'selected' : '' }}   value="2">من الاول الى الثانى</option>
                                        <option  {{ request('rate_limiting') == 3 ? 'selected' : '' }}   value="3">من الاول الى الثالث</option>
                                        <option  {{ request('rate_limiting') == 20 ? 'selected' : '' }}   value="20">من الاول الى العشرون</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="file-upload-wrapper p-1">
                                    <input name="search" value="{{ request('search')}}"  placeholder="ألاسم / رقم الهوية / رقم الهاتف"
                                           class="form-control form-control-sm">
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="file-upload-wrapper p-1">
                                    <div class="d-flex">
                                        ...
                                        <input name="details_date" value="{{ request('details_date')}}" type="date"
                                               class="form-control form-control-sm">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="file-upload-wrapper p-1">
                                    <div class="d-flex">
                                        ...
                                        <input name="total" value="{{ request('total')}}" type="number" min="0"
                                               class="form-control form-control-sm">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex">
                            ...
                            <div class="col-8 ">
                                <div class="file-upload-wrapper p-1 d-flex">
                                    ...
                                    <button type="submit" value="submit" class="btn btn-sm btn-warning ml"> بحث</button>

                                    <a class="btn btn-sm btn-primary ml" href="{{route('final_reports.index')}}">
                                        اعادة ضبط </a>
                                </div>
